...
class ZonawebWebsite(http.Controller):
    ...
    # ELIMINADA la ruta '/' — en Odoo 18 la homepage se gestiona
    # mediante is_homepage=True en el registro website.page
    ...
    def submit_bidding(self, **kwargs):
        ...
        try:
            ...
            # Enviar email de confirmación (si existe la plantilla)
            try:
            ...
            return request.render('website.http_error', {
                'error_message': 'Ha ocurrido un error. Por favor, inténtalo de nuevo.',
            })
